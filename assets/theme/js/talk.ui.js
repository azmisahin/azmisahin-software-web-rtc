...
TalkUI.prototype.AddScreenMessage = function (from, message, me) {
    ...
    if (me) {
        ...
        html += "<div class='text-left'>" + userCityName + " / " + userLocation.latitude + ":" + userLocation.longitude + "</div>"
        html += "<span>" + user + "</span>"
        html += "</h6>"
        ...
        html += "<div class='media-body'>"
        html += "<h6 class='mt-0 mb-1  font-weight-lighter'>"
        html += "<div class='text-right'>" + userCityName + " / " + userLocation.latitude + ":" + userLocation.longitude + "</div>"
        html += "<span>" + user + "</span>"
        html += "</h6>"
        html += "<h6 class='font-italic'>" + message + "</h6>"
        html += "</div>"
